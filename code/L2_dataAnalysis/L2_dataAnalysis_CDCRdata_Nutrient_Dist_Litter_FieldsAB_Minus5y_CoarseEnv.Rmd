...
```{r}
workingdir <- getwd()
datain <- file.path(workingdir, "data/L1/DataModel_CoarseEnv_FieldsAB")
...
Importing dataset
```{r}
load(file.path(datain,"DataModel_Dist_Litter_FieldsAB_Minus5y_CoarseEnv.RData"))
