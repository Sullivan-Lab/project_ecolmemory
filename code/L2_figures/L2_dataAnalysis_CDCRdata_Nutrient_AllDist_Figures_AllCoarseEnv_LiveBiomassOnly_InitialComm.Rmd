...
left_column
ggsave(file.path(graph.wd,"Fig4_DiffMemoryLength_LiveBiomass.png"), plot = last_plot(), width=7, height=4, dpi = res_export, units="in")
```
...
left_column
ggsave(file.path(graph.wd,"FigSF_DiffMemoryLength_LiveBiomass.png"), plot = last_plot(), width=7, height=8, dpi = res_export, units="in")
```
...
left_column <- plot_grid(final_a, final_b, ncol = 1)
left_column
ggsave(file.path(graph.wd,"EXTRA_FigSF_DiffMemoryLength_75_LiveBiomass.png"), plot = last_plot(), width=7, height=8, dpi = res_export, units="in")
```
...
left_column <- plot_grid(final_a, final_b, ncol = 1)
left_column
ggsave(file.path(graph.wd,"EXTRA_FigSF_DiffMemoryLength_90_LiveBiomass.png"), plot = last_plot(), width=7, height=8, dpi = res_export, units="in")
```
...
ggsave(file.path(graph.wd,"FigSV_MemoryTempPattern_LiveBiomass.png"), plot = last_plot(), width=11, height=9, dpi = res_export, units="in")
```
