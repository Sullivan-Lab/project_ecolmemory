...
a<-
 ...
 scale_x_continuous(expand = c(0.01,0),
  ...
  geom_text(data = filter(WEIGHTMomodelpar, ntrt %in% c(9)),  #WEIGHTMomodelpar,
               aes(x = 6.5, y = 0.225), inherit.aes = FALSE, label = "Precipitation", color = "black", size = 5, fontface = "bold")+
  theme_facet2+
...
b<-
  ...
  geom_text(data = filter(WEIGHTMomodelpar, ntrt %in% c(9)),  #WEIGHTMomodelpar,
               aes(x = 6.5, y = 0.240), inherit.aes = FALSE, label = "Temperature", color = "black", size = 5, fontface = "bold")+
  theme_facet2+
  theme(legend.position = "none",
        legend.title = element_blank(),
        legend.justification = "right",
