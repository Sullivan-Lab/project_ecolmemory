...
a<-
  ...
  facet_wrap(~dur, nrow=2, scales = "free_y",
             labeller = labeller(dur = c("1" = "Precipitation: All Years", "2" = "Precipitation: No Initial Response")))+
...
final_a <- ggdraw(a) +
  ...
  draw_label("†", x = 0.245, y = 0.710, size = 10, fontface = "bold", hjust = 0, vjust = 1, color = "#ffba76")
...
b<-
  ...
  scale_shape_manual(values = c(19, 17),
                     labels = c("Intact","Disturbed")) +
  facet_wrap(~dur, nrow=2, scales = "free_y",
             labeller = labeller(dur = c("1" = "Temperature: All Years", "2" = "Temperature: No Initial Response")))+
  xlab(expression(bold("Nutrient addition (g N/m"^2*"/yr)")))+
    ylab("Effect of past weather on biomass\n(posterior mean ± 95% CIs)")+
  coord_cartesian(clip = "off",
                   xlim=c(-0.3,27.2))+
...
final_b <- ggdraw(b) +
  draw_label("c)", x = 0.175, y = 0.969, size = 13, fontface = "bold", hjust = 0, vjust = 1) +
  draw_label("d)", x = 0.175, y = 0.520, size = 13, fontface = "bold", hjust = 0, vjust = 1) +
  # Rain cloud
  draw_image(image = icon_temp, x = -0.395, y = 0.44, scale = 0.060) +  # Panel A.
  draw_label("†", x = 0.238, y = 0.760, size = 10, fontface = "bold", hjust = 0, vjust = 1, color = "#ffba76")
...
ggsave(file.path(graph.wd,"Fig2_EnvCoefVSNtrt.png"), plot = last_plot(), width=6, height=8, dpi = res_export, units="in")
```
...
a<-
 ...
 final_a <- ggdraw(a) +
  ...
  draw_label("†", x = 0.300, y = 0.435, size = 10, fontface = "bold", hjust = 0, vjust = 1, color = "#ffba76")
...
ggplot(aes(y=mean_mem_length,
 ...
 final_b <- ggdraw(b) +
  ...
  draw_label("†", x = 0.300, y = 0.402, size = 10, fontface = "bold", hjust = 0, vjust = 1, color = "#ffba76")
